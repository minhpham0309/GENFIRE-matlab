...
if isempty(initialObject)
    initialObject = zeros(size(support),'single');
end
...
[GENFIRE_rec, errK, Rfree_complex] = GENFIRE_iterate_DR(numIterations,initialObject,support,tmpMeasuredK,resolutionIndicators,constraintEnforcementDelayIndicators,R_freeInd_complex,R_freeVals_complex, constraintPositivity, constraintSupport);   
