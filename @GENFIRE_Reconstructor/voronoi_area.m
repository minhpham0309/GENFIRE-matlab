...
[ky, kx] = meshgrid((1:dim1)-nc,(1:dim1)-nc);
...
mem_overlap = ismember(measuredX,X) & ismember(measuredZ,Z) & ismember(measuredY,Y);
measuredX_r = measuredX(~mem_overlap);
measuredY_r = measuredY(~mem_overlap);
measuredZ_r = measuredZ(~mem_overlap);
